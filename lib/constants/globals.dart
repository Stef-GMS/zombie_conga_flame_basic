late String deviceSize;
late double width = 2048;
late double height = 1156;

class Globals {
  Globals._();

  static const String backgroundParallaxSprite = 'background.png';
  static const String backgroundMusic = 'background_music.mp3';
  // static const String backgroundParallaxSprite1 = 'background1.png';
  // static const String backgroundParallaxSprite2 = 'background2.png';
